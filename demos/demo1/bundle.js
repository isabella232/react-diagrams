...
window.onload = function () {
    ...
    var TestComponent = (function (_super) {
        ...
        function TestComponent(props) {
            var _this = _super.call(this, props) || this;
            _this.engine = new SRD.DiagramEngine();
            _this.engine.registerNodeFactory(new SRD.DefaultNodeFactory());
            _this.engine.registerLinkFactory(new SRD.DefaultLinkFactory());
            //2) setup the diagram model
            _this.model = new SRD.DiagramModel();
            //5) load model into engine
            _this.engine.setDiagramModel(_this.model);
            return _this;
        }
    ...
    var TestWrapper = (function (_super) {
        __extends(TestWrapper, _super);
        ...
        TestWrapper.prototype.render = function () {
            return (React.createElement("div", null,
                ...
                React.createElement("div", { style: { width: 200, height: 200 } },
                    React.createElement(TestComponent, { nodes: nodes }))));
        };
        return TestWrapper;
    }(React.Component));
    ReactDOM.render((React.createElement(TestWrapper, null)), document.body);
